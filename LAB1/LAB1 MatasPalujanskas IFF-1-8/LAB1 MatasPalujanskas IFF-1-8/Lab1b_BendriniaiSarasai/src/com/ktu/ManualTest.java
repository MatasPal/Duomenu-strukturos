...
public class ManualTest {
    ...
    static void testStack(Stack<Car> stack){
        System.out.println();
        stack.push(new Car("Test", "Test1", 1997, 1050, 700));
        stack.push(new Car("Test", "Test2", 1996, 700, 870));
        stack.push(new Car("Test", "ToRemove(Test3)", 2001, 1000, 1000));
        System.out.println("Popped car: " + stack.pop().toString());
        System.out.println("Ar sarasas yra tuscias?");
        System.out.println(stack.isEmpty());
        System.out.println("Pirmo elemento grazinimas po pop: " + stack.peak());
    }
    ...
    static void testQueue(Queue<Car> queue){
        ...
        System.out.println("Dequeue index: " + queue.dequeue(2));
